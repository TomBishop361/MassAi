...
{
    public FlowFieldManager gridController;
    ...
    {
        if (currentFlowField == null) { return; }
        DisplayCell(currentFlowField.destinationCell);
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        switch (currentDisplayType)
        {
            case FlowFieldDisplayType.CostField:
                ...
                foreach (Cell currentCell in currentFlowField.grid)
                {
                    Handles.Label(currentCell.worldPos, currentCell.cost.ToString(), style);
                }
                break;
            ...
            case FlowFieldDisplayType.IntegrationField:
                ...
                foreach (Cell currentCell in currentFlowField.grid)
                {
                    Handles.Label(currentCell.worldPos, currentCell.bestCost.ToString(), style);
                }
                break;
